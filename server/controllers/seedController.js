...
exports.seedDatabase = async (req, res) => {
  try {
    ...
    const cards = await GhostCard.insertMany([
      ...
      {creatorId:users[9]._id,title:"Fitness Tracker",description:"Workout logging and progress tracking",type:"Mobile App",image:"https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?w=400&h=300&fit=crop",status:"revived",revivedBy:users[3]._id},
      {creatorId:users[10]._id,title:"Social Media Dashboard",description:"Analytics for multiple social platforms",type:"Web App",image:"https://images.unsplash.com/photo-1611262588024-d12430b98920?w=400&h=300&fit=crop",status:"buried"},
      {creatorId:users[11]._id,title:"Learning Management System",description:"Online course platform with video streaming",type:"Web App",image:"https://images.unsplash.com/photo-1501504905252-473c47e087f8?w=400&h=300&fit=crop",status:"revived",revivedBy:users[4]._id},
      {creatorId:users[12]._id,title:"Inventory Management",description:"Stock tracking for small businesses",type:"Desktop App",image:"https://images.unsplash.com/photo-1586953208448-b95a79798f07?w=400&h=300&fit=crop",status:"buried"},
      {creatorId:users[13]._id,title:"Event Booking System",description:"Ticket booking and event management",type:"Web App",image:"https://images.unsplash.com/photo-1492684223066-81342ee5ff30?w=400&h=300&fit=crop",status:"revived",revivedBy:users[8]._id},
      ...
      {creatorId:users[9]._id,title:"Game Engine",description:"2D game development framework",type:"Library",image:"https://images.unsplash.com/photo-1511512578047-dfb367046420?w=400&h=300&fit=crop",status:"buried"},
      {creatorId:users[10]._id,title:"API Gateway",description:"Microservices routing and authentication",type:"Backend",image:"https://images.unsplash.com/photo-1558494949-ef010cbdcc31?w=400&h=300&fit=crop",status:"revived",revivedBy:users[6]._id}
    ]);
