  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-6">
      ...
      <div
        ...
        onClick={onClose} // instant close
      ></div>

      {/* Modal */}
      <div
        className={`relative w-full max-w-2xl max-h-[90vh] overflow-y-auto glass-strong rounded-2xl p-8 neon-glow
      ...
      >
        ...
        <button
          ...
          className="absolute top-4 right-4 z-[9999] glass rounded-full p-2 hover:glass-strong transition-all duration-300"
        >
        ...
        <div className="relative z-10">
          ...
          <div className="flex gap-3">
            ...
            {!isOwner && project.status === "RIP" && (
              <Button className="bg-[#34e0a1] text-[#141d38] hover:bg-[#34e0a1]/90 neon-glow">
